  ...
  return (
    <div className='flex gap-2'>
      <div className='flex-1 flex items-center gap-1'>
        ...
        <Input
          placeholder='Tìm kiếm công việc theo tiêu đề công việc'
          className='w-full border-none font-medium dark:bg-transparent'
        />
      </div>
      <div className='flex-none'>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              size='icon'
              className='w-8 h-8 rounded-full bg-default-100 group'
            >
