...
export const exportToExcel = async (
  dataInput: Partial<BachelorExportRow>[] | BachelorExportRow[] | null | undefined,
  ...
  try {
    ...
    const formattedData = data.map((s: Partial<BachelorExportRow> = {}) => {
